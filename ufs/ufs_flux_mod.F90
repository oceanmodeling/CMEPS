module ufs_flux_mod
  ...
  use ufs_const_mod, only : shr_const_zvir, shr_const_cpdair, shr_const_cpvir, shr_const_karman, shr_const_g
  use ufs_const_mod, only : shr_const_latvap, shr_const_latice, shr_const_stebol, shr_const_tkfrz
  use ufs_const_mod, only : shr_const_ocn_ref_sal, shr_const_zsrflyr, shr_const_rgas
  ...
  ! values.  The default values are from ufs_const_mod.  Currently they are
